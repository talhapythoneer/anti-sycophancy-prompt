...
Pulled from the reference list of the Wikipedia article [Sycophancy (artificial intelligence)](https://en.wikipedia.org/wiki/Sycophancy_(artificial_intelligence)), which this prompt is based on.
